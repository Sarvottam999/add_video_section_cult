...
// import 'package:tryapp3/components/add_Video/s_5_add_video_form/add_video_form_screen.dart';
...
class _s_4_videoItemState extends State<s_4_videoItem> {
  ...
  Widget build(BuildContext context) {
    final loader_video_provider = Provider.of<add_video_provider>(context);
      ...
      child: Stack(children: [
          ...
          header: GridTileBar(
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                if (loader_video_provider.getItems.length == 1 ) {
